    ...
    return (React.createElement(react_1.Container, { pt: 10, maxW: "container.xl", pb: 20 },
        ...
        React.createElement(react_1.Center, { mt: 10, gap: 5, justifyContent: "center", flexDirection: { base: "column", md: "row" } },
            React.createElement(react_1.Center, null,
                React.createElement(react_1.Box, { bg: react_1.useColorModeValue("gray.100", "gray.900"), overflowX: "auto", p: 8, rounded: "lg", boxShadow: "rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px" },
                    !isOpen ? (React.createElement(react_1.Box, null,
                        ...
                        React.createElement(react_1.Text, null,
                            ...
                            "Com a experi\u00EAncia que obtive no meu primeiro emprego hoje atendo empresas que precisam de Landing Pages e e-commerces, sempre utilizando as melhores estr\u00E1tegias para que meu cliente possa ter resultado e ser visto no mercado. Sempre procurando as melhores pr\u00E1ticas e me aperfei\u00E7oando cada vez mais."))) : (React.createElement(react_1.Box, null,
                    ...
                    React.createElement(react_1.Center, { justifyContent: "space-between", alignItems: 'end', gap: 5, mt: 5 },
                        React.createElement(react_1.Box, null,
                            React.createElement(react_1.Button, { colorScheme: "teal", variant: "outline", size: "sm", mt: 5 },
                                React.createElement("a", { href: "/linkedin_profile.pdf", download: true }, "Download CV"))),
                        React.createElement(react_1.Center, null,
                            React.createElement(react_1.Text, { fontWeight: 'bold' }, !isOpen ? "Minhas Skills" : "Sobre mim"),
