...
var Home = function (_a) {
    var data = _a.data;
    return (React.createElement(react_1.Box, { overflow: 'hidden' },
        React.createElement(head_1["default"], null,
            React.createElement("title", null, "Raphael Caetano"),
        ...
        React.createElement(Projects_1.Projects, { data: data }),
...
exports.getStaticProps = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("https://api.github.com/users/raphactn/repos")];
            case 1:
                response = _a.sent();
